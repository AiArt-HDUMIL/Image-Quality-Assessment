...
parser.add_argument(
    '--pathA',
    type=str,
    default='/home/fangnan/project/mocogan-v0/results/GAN_20201208-204335/01',
    help=('Path to the generated images or to .npz statistic files'))
parser.add_argument(
    '--pathB',
    type=str,
    default='/data/fangnan/photostick/CUHK5/trainB',
    help=('Path to the generated images or to .npz statistic files'))
...
def _compute_statistics_of_path(path, model, batch_size, dims, cuda):
    if path.endswith('.npz'):
        ...
        imgs = np.array([
            imread(str(fn), pilmode="RGB").astype(np.float32) for fn in files
        ])
...
def random_copyfile(srcPath, dstPath, numfiles):
    name_list = list(
        os.path.join(srcPath, name) for name in os.listdir(srcPath))
...
if __name__ == '__main__':
    ...
    fid_value = calculate_fid_given_paths(args.pathA, args.pathB,
